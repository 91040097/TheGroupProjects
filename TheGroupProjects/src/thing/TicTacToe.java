...
public class TicTacToe extends JFrame
{
	...
	/**
	 * Advanced Topics in CS: FINAL PROJECT
	 */
	//private static final long serialVersionUID = 1L;
	int ct = 0;
	boolean x = true;
	int[] board = {0,0,0,0,0,0,0,0,0}; JButton[] jb = new JButton[9]; // game board as an array of Jbuttons, places initalized to 0
	JPanel panel;
	JRadioButton rbx;
	JRadioButton rbo;
	JPanel gPanel;
	...
	private class QuitButtonListener implements ActionListener //'quit' [button] game
	{
		public void actionPerformed(ActionEvent event)
		{
			System.exit(0);
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			for(int j = 0; j < 9; j++){
				if(board[j] == 1){
					...
					jb[j].setForeground(Color.BLACK);
				}
			}
		}
	}
